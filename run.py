...
from pages import index, predictions, insights, process, fuel
        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/aaron-scott-chicago/'), 
